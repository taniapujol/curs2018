...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        ...
                        <p class="text-muted">Add some information about the album below, the author, or any other background context. Make it
                            a few sentences long so folks can pick up some informative tidbits. Then, link them off to some
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Album de fotos</h1>
            </div>
        </section>
        <!-- Seccion principal del album -->
        <?php  
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <img class="card-img-top" scr="img/">
                            <div class="card-body">
