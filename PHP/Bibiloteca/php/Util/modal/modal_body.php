...
switch ($_REQUEST['section']) {  
    ...
    case 'ver':   
        ...
        while ($row=mysqli_fetch_array($result)){?>
            <!-- html de modal cuando la opcion es ver -->
            <div class="row">
                <div class="col-sm">
                    ...
                    <td>
                        ...
                        if($row['deteriodo']==0){?>
                            <div class="form-check">
                                <input class="form-check-input position-static" type="radio" name="deteriodo" id="deteriodo" value="0">
                            </div>
                        <?php } else {?>
                            <div class="form-check">
                                <input class="form-check-input position-static" type="radio" name="deteriodo" id="deteriodo" value="1" checked>
                            </div>
                        <?php } ?>  
                    </td>
                    <td>
